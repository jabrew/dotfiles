...
{   ; Se grabaron datos de posiciones de ventanas hace 5 segundos o menos.
    FileAppend, % "* " . A_YYYY . "-" . A_MM . "-" . A_DD . " " . A_Hour . ":" . A_Min . ":" . A_Sec . " --> " . "SaveWinPositions:-> Se grabaron datos de posiciones de ventanas hace " . TiempoTranscurrido . " segundos. Disparo en falso del salvapantallas. No se almacenarán posiciones de ventanas. Saliendo de SaveWinPositions. `n", %WindowPositionLocation%\WinPositions-Log.txt
...
{       ; Si no hay parámetros, capturamos el número de pantallas del fichero de configuración (por defecto en el directorio de ejecución del programa), si existe:
    ...
    {   ; ... leemos de él el número de pantallas esperado.
        ...
        FileAppend, % "* " . A_YYYY . "-" . A_MM . "-" . A_DD . " " . A_Hour . ":" . A_Min . ":" . A_Sec . " --> " . "SaveWinPositions:-> No se introdujeron parámetros, se utilizará el extraído del fichero de configuración.`n", %WindowPositionLocation%\WinPositions-Log.txt
    } else
    {   ; No existe el fichero de configuración: informamos en el log.
        FileAppend, % "* " . A_YYYY . "-" . A_MM . "-" . A_DD . " " . A_Hour . ":" . A_Min . ":" . A_Sec . " --> " . "SaveWinPositions:-> No existe el fichero de configuración.`n", %WindowPositionLocation%\WinPositions-Log.txt
    }
...
{   ; Si hay parámetros...
    ...
    FileAppend, % "* " . A_YYYY . "-" . A_MM . "-" . A_DD . " " . A_Hour . ":" . A_Min . ":" . A_Sec . " --> " . "SaveWinPositions:-> Ignorando número de monitores: se ejecutará el programa sin esperarlos.`n", %WindowPositionLocation%\WinPositions-Log.txt
    } else
...
{   ; ... añadimos una entrada al log con el número de pantallas necesarias.
    FileAppend, % "* " . A_YYYY . "-" . A_MM . "-" . A_DD . " " . A_Hour . ":" . A_Min . ":" . A_Sec . " --> " . "SaveWinPositions:-> Numero de monitores esperado: " . NumeroDePantallasEsperado ".`n", %WindowPositionLocation%\WinPositions-Log.txt
}
; Comprobamos que estén todos los monitores conectados:
SysGet, m, MonitorCount
If ( not IgnoreNumPantallas and m < NumeroDePantallasEsperado )
{
    FileAppend, % "* " . A_YYYY . "-" . A_MM . "-" . A_DD . " " . A_Hour . ":" . A_Min . ":" . A_Sec . " --> " . "SaveWinPositions:-> Número de pantallas actual: " . m . "; se esperaba al menos " . NumeroDePantallasEsperado . ". Saliendo de SaveWinPositions. `n", %WindowPositionLocation%\WinPositions-Log.txt
...
FileAppend, % "* " . A_YYYY . "-" . A_MM . "-" . A_DD . " " . A_Hour . ":" . A_Min . ":" . A_Sec . " --> " . "SaveWinPositions:-> Grabando posiciones de las ventanas del Escritorio `n", %WindowPositionLocation%\WinPositions-Log.txt
FileDelete, %WindowPositionLocation%\WindowsPositions.txt
WinGet windows, List
Loop %windows%
{
    ...
    FileAppend , %r%, %WindowPositionLocation%\WindowsPositions.txt
}

; Ordenamos por ID de ventana el fichero resultante:
FileRead, OutputVar, %WindowPositionLocation%\WindowsPositions.txt
...
FileDelete, %WindowPositionLocation%\WinPos-.txt
FileCopy, %WindowPositionLocation%\WinPos--.txt, %WindowPositionLocation%\WinPos---.txt
FileCopy, %WindowPositionLocation%\WinPos-.txt, %WindowPositionLocation%\WinPos--.txt
FileCopy, %WindowPositionLocation%\WinPos.txt, %WindowPositionLocation%\WinPos-.txt
FileDelete, %WindowPositionLocation%\WinPos.txt
FileAppend, %OutputVar%,%WindowPositionLocation%\WinPos.txt
